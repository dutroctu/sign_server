...
REQUIRE_KEY = {
    ...
    OEM_ATTEST_CERT_FNAME:".",
    OEM_ATTEST_KEY_FNAME:".",
    }

KEY_TOOL_NAME = "quectel_sb_attest"

REQUIRE_KEY_DESC = {
    OEM_ROOTCA_CERT_FNAME:"Root CA cert",
    OEM_ATTEST_CERT_FNAME:"Attestion cert",
    OEM_ATTEST_KEY_FNAME:"Attestion key",
}

class QuectelSbAttestKeyTool(KeyTool):
